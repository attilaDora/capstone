...
import SearchFeld from "./compononents/SearchFeld";
import {ChangeEvent, useState} from "react";

export default function App() {

    const cocktailsResponse = {
        "drinks": [
            {
                "idDrink": "11000",
                "strDrink": "Mojito",
    ...
    const filteredCocktails = cocktailsResponse.drinks.filter(cocktail => cocktail.strDrink.toLocaleLowerCase().includes(searchText.toLocaleLowerCase()))
    ...
    return (
        <div className="App">
            <Header />
            <br/>
            <SearchFeld searchText={searchText} onSearchInputChange={onSearchInputChange} />
